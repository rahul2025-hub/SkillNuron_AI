"""Resume analysis using TF-IDF and cosine similarity for career matching."""
import os
import re
...
def analyze_resume(resume_text: str) -> Dict[str, Any]:
    """
    Analyze resume text and provide career recommendations.

    Args:
        resume_text: The raw text content of the resume.

    Returns:
        Dictionary containing role prediction, confidence, skills, and roadmap.
    """
    # Get the data path relative to this file
